...
static const void* button_sensor_cmpobj_functions[FUNCTION_BUTTON_SENSOR_LAST]={};

static const hil_component_t button_sensor_cmpobj = { { BUTTON_SENSOR, 2, 7, HIL_COMPONENT} , {FUNCTION_BUTTON_SENSOR_LAST,button_sensor_cmpobj_functions} };
