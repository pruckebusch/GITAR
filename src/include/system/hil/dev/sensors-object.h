...
static const hil_component_t sensors_cmpobj = { { SENSORS, 2, 7, HIL_COMPONENT, 7, "sensors"} , {sensors_cmpobj_functions, sensors_cmpobj_processes, FUNCTION_SENSORS_LAST, PROCESS_SENSORS_LAST} };
