...
static const component_t collect_link_estimate_cmpobj = { { COLLECT_LINK_ESTIMATE, 2, 7, NET_COMPONENT} , {FUNCTION_COLLECT_LINK_ESTIMATE_LAST,collect_link_estimate_cmpobj_functions} , {&collect_link_estimate_object_init, NULL, NULL}};
