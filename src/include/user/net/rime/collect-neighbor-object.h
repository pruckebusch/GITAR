...
static const component_t collect_neighbor_cmpobj = { { COLLECT_NEIGHBOR, 2, 7, NET_COMPONENT} , {FUNCTION_COLLECT_NEIGHBOR_LAST,collect_neighbor_cmpobj_functions} , {&collect_neighbor_object_init, NULL, NULL}};
