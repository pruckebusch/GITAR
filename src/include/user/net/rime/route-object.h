...
static const struct process* route_cmpobj_processes[PROCESS_ROUTE_LAST] = {};

static const component_t route_cmpobj = { { ROUTE, 2, 7, NET_COMPONENT, 5, "route"} , {route_cmpobj_functions, route_cmpobj_processes, FUNCTION_ROUTE_LAST, PROCESS_ROUTE_LAST},{&route_object_init, NULL, NULL}};
